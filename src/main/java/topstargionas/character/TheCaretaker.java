package topstargionas.character;
...
import topstargionas.cards.basic.Prepare;
import topstargionas.cards.rare.SuperChargedStar;
import topstargionas.relics.StarCore;

import java.util.ArrayList;

import static topstargionas.TopStarGionasMod.characterPath;
import static topstargionas.TopStarGionasMod.makeID;

public class TheCaretaker extends CustomPlayer {
    //Stats
    public static final int ENERGY_PER_TURN = 3;
    public static final int MAX_HP = 75;
    public static final int STARTING_GOLD = 157;
    ...
    public static class Meta {
        ...
        @SpireEnum
        public static PlayerClass THE_CARETAKER;
        @SpireEnum(name = "THE_CARETAKER_COLOR") // These two MUST match. Change it to something unique for your character.
        public static AbstractCard.CardColor CARD_COLOR;
        @SpireEnum(name = "THE_CARETAKER_COLOR") @SuppressWarnings("unused")
        ...
        public static void registerCharacter() {
            BaseMod.addCharacter(new TheCaretaker(), CHAR_SELECT_BUTTON, CHAR_SELECT_PORTRAIT);
        }
    }
    ...
    public TheCaretaker() {
        /*
        super(getNames()[0], Meta.THE_CARETAKER,
                new CustomEnergyOrb(orbTextures, characterPath("energyorb/vfx.png"), layerSpeeds), //Energy Orb
                new SpriterAnimation(characterPath("animation/default/default.scml"))); //Animation
        */

        super(getNames()[0], Meta.THE_CARETAKER,
                new CustomEnergyOrb(orbTextures, characterPath("energyorb/vfx.png"), layerSpeeds),
                new SpineAnimation("topstargionas/images/character/animation/skeleton.atlas",
                                "topstargionas/images/character/animation/skeleton.json", 1.0f));
    ...
    public ArrayList<String> getStartingDeck() {
        ...
        retVal.add(Prepare.ID);
        retVal.add(Prepare.ID);
        retVal.add(SuperChargedStar.ID);

        UnlockTracker.markCardAsSeen(SuperChargedStar.ID);
    ...
    public ArrayList<String> getStartingRelics() {
        ...
        retVal.add(StarCore.ID);
        //retVal.add(PrismaticShard.ID);
        UnlockTracker.markRelicAsSeen(StarCore.ID);
