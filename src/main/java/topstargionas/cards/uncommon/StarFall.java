...
public class StarFall extends BaseCard {
    // makeID adds the mod ID, so the final ID will be something like "modID:MyCard"
    public static final String ID = makeID(StarFall.class.getSimpleName());
    ...
    private static final int UPG_DRAWCARD = 1;
    ...
    public StarFall() {
        ...
        setCustomVar("DRAWCARD", DRAWCARD, UPG_DRAWCARD);
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        addToBot(new ApplyPowerAction(p, p, new topstargionas.powers.DrawPassiveStartTurn(p, customVar("DRAWCARD"))));
    }
}