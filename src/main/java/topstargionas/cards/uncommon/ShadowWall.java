...
public class ShadowWall extends BaseCard {
    ...
    public static final String ID = makeID(ShadowWall.class.getSimpleName());
    ...
    public ShadowWall() {
        ...
        setCustomVar("Burn", BURN, UPG_BURN);
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        for (AbstractMonster mo : AbstractDungeon.getMonsters().monsters) {
            addToBot(new ApplyPowerAction(mo, mo, new BurnTheStars(mo, customVar("Burn"))));
        }
    }
}
