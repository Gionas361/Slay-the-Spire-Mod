package topstargionas.cards.curse;
...
public class HellBurn extends BaseCard {
    ...
    private static final int UPG_BURN = 1;
    ...
    public HellBurn () {
        ...
        setCustomVar("BURN", BURN, UPG_BURN); // Sets the card's damage and how much it changes when upgraded.
    ...
    public void triggerOnOtherCardPlayed(AbstractCard c) {
        addToBot(new ApplyPowerAction(AbstractDungeon.player, AbstractDungeon.player, new BurnTheStars(AbstractDungeon.player, customVar("BURN"))));
    }
}
