...
import topstargionas.util.TriFunction;
...
import static topstargionas.util.GeneralUtils.removePrefix;
import static topstargionas.util.TextureLoader.getCardTextureString;


public abstract class BaseCard extends CustomCard {
    final private static Map<String, DynamicVariable> customVars = new HashMap<>();

    protected static String makeID(String name) { return TopStarGionasMod.makeID(name); }
    ...
    protected final void setSelfRetain() {this.setSelfRetain(retain, retain); }
    ...
    public void upgrade()
    {
        if (!upgraded)
        {
            ...
            if (this.upgradesDescription)
            {
                ...
                {
                    TopStarGionasMod.logger.error("Card " + cardID + " upgrades description and has null upgrade description.");
                }
                else
                {
